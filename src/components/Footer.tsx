    ...
    <footer className="mt-auto border-t border-white/10 bg-ieee-dark text-white">
      <div className="mx-auto grid max-w-6xl gap-12 px-4 py-16 sm:grid-cols-2 lg:grid-cols-4 md:px-6">
        <div>
          ...
          <p className="text-sm leading-relaxed text-slate-400">
            Advancing communications and networking technology in Rwanda. Part
          ...
          <a
            ...
            className="mt-5 inline-flex items-center gap-2 text-sm text-slate-400 transition-colors hover:text-accent-bright"
          >
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-6xl px-4 py-5 md:px-6">
          <ul className="mb-3 flex flex-wrap justify-center gap-x-6 gap-y-1 text-xs text-slate-500 sm:justify-start">
            {legalLinks.map((l) => (
              <li key={l.href}>
                <a
                  href={l.href}
